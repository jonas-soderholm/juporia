...
const LessonData = {
  ...
  sections: [
    {
      id: 1,
      sectionTitle: "Welcome to your first lesson!",
      content: [
        "Sometimes you'll need to answer questions to continue and reinforce learning. ",
      ],
      question: " Type 'yes' and submit if you understand to proceed.",
      answerKeywords: ["yes"],
    },
    {
      id: 2,
      sectionTitle: "Darkmode vs lightmode",
      content: [
        "Switch between dark and light mode in the header for a more comfortable reading experience.",
      ],
      question: "",
      answerKeywords: [""],
      images: ["/images/other/switch-darkmode.png"],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content: [
        ...
        "A strong password should be at least 12 characters long and include a mix of uppercase letters, lowercase letters, numbers, and symbols. Avoid easy words, names, or birthdays. Instead of 'password123,' use a random passphrase like ‘GreenHorse#Bubble99.’",
        "The longer the password, the better—12 characters is a good start, but 14+ is even more secure!",
      ],

      question: "Name atleast one good characteristic of a password?",
      answerKeywords: [
        "uppercase",
        "lowercase",
        "numbers",
